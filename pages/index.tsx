...
import HomeParticles from "../components/Home/Particles/HomeParticles";
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://emilejuniorada.com`} />
        <link rel="canonical" href={`https://emilejuniorada.com`} />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Emile Junior ADA" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@mjkawaguchi" />
      ...
      <div className="relative snap-mandatory min-h-screen bg-AAprimary w-full ">
        ...
        {context.sharedState.finishedLoading ? (
          <Footer
            myUrl={"https://github.com/MeijinK/portfolio"}
