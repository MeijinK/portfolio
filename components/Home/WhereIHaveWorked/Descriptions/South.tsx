...
export default function South() {
  const tasks = [
    {
      text: "Responsable du développement de l'application web du programme de fidélité 'Le Club SID' à l'aide de CodeIgniter, HTML/CSS/JS",
      keywords: ["CodeIgniter", "HTML/CSS/JS"],
    },
  ];
