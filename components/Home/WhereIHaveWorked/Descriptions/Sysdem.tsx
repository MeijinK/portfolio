...
export default function Sysdem() {
  const tasks = [
    {
      text: "Réalisation et Maintenance du CRM pour déménageurs Sysdem utilisant Vue3, InertiaJs, Laravel.",
      keywords: ["Vue3", "InertiaJs", "Laravel"],
    },
  ];
  return (
    <>
      <div className="flex flex-col space-y-5 max-w-xl px-4 md:px-0">
        <div className="flex flex-col spacey-y-2">
          ...
          <span
            ...
            onClick={() => window.open("https://www.sysdem.com/", "_blank")}
          >
            www.sysdem.com
          </span>
        </div>
