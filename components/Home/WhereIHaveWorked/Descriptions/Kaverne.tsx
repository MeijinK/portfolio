...
export default function Kaverne() {
  const tasks = [
    {
      text: "Responsable technique des projets réalisés par l'agence avec des outils comme Next.js, Wordpress, ExpressJs.",
      keywords: [
        "Responsable",
        "technique",
        "Next.js",
    ...
    {
      text: "Gestion d'équipe et de projets.",
      keywords: ["équipe"],
    },
    {
      ...
      <div className="flex flex-col space-y-5 max-w-xl px-4 md:px-0">
        <div className="flex flex-col spacey-y-2">
          ...
          <span
            ...
            onClick={() =>
              window.open("https://www.lakavernedigitale.com/", "_blank")
            }
          >
            www.lakavernedigitale.com
          </span>
        </div>
