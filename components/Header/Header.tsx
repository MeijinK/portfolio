...
const Header = (props: { finishedLoading: boolean; sectionsRef }) => {
  ...
  const [rotateDesktop, setRotateDesktop] = useState<boolean>(false);
    ...
    <>
      ...
      >
        ...
        <DesktopMenu
          ...
          setRotate={setRotateDesktop}
          setShowElement={setShowDesktopElement}
          ShowElement={ShowDesktopElement}
